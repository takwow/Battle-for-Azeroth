...
m_name(""), m_isActive(false), m_isFarVisible(false), m_isWorldObject(isWorldObject), m_zoneScript(NULL),
...
std::list<Creature*> WorldObject::FindAllCreaturesInRange(float range)
{
    ...
    Trinity::AllCreaturesInRange checker(this, range);
    Trinity::CreatureListSearcher<Trinity::AllCreaturesInRange> searcher(this, templist, checker);
