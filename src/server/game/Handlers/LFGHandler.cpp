...
void WorldSession::SendLfgUpdateStatus(lfg::LfgUpdateData const& updateData, bool party)
{
    ...
    switch (updateData.updateType)
    {
        ...
        case lfg::LFG_UPDATETYPE_ADDED_TO_QUEUE:                // Rolecheck Success
            ...
            queued = true;
            break;
        case lfg::LFG_UPDATETYPE_JOIN_RAID_BROWSER:
            join = true;
            extraData = true;
            break;
        ...
        case lfg::LFG_UPDATETYPE_UPDATE_STATUS:
            ...
            queued = updateData.state == lfg::LFG_STATE_QUEUED || updateData.state == lfg::LFG_STATE_RAID_BROWSER;
            break;
        default:
            break;
    }
    ...
    lfgUpdateStatus.Queued = extraData;
