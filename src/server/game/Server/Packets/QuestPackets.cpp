...
WorldPacket const* WorldPackets::Quest::QueryQuestInfoResponse::Write()
{
    ...
    if (Allow)
    {
        ...
        _worldPacket.WriteBits(Info.LogTitle.size(), 10);
        ...
        _worldPacket.WriteBits(Info.PortraitGiverText.size(), 11);
        _worldPacket.WriteBits(Info.PortraitGiverName.size(), 9);
        _worldPacket.WriteBits(Info.PortraitTurnInText.size(), 11);
        _worldPacket.WriteBits(Info.PortraitTurnInName.size(), 9);
        _worldPacket.WriteBits(Info.QuestCompletionLog.size(), 12);
        _worldPacket.FlushBits();
