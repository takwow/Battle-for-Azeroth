...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    {
        const_cast<SpellEffectInfo*>(spellInfo->GetEffect(EFFECT_0))->MaxRadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_100_YARDS);
    });
    ...
    {
        const_cast<SpellEffectInfo*>(spellInfo->GetEffect(EFFECT_0))->MaxRadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_50000_YARDS);
    });
    ...
    // DEMON HUNTER SPELLS
    ApplySpellFix({ 131347 }, [](SpellInfo* spellInfo)
    {
        spellInfo->AuraInterruptFlags[0] |= AURA_INTERRUPT_FLAG_LANDING;
    });
    // END DEMON HUNTER SPELLS
